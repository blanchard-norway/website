  ...
  return (
    <>
      ...
      <nav className="navbar navbar-default navbar-fixed-top">
        <div className="container logo">
          <div className="navbar-header">
            ...
            <a className="navbar-brand" href="/"><Image src="/images/global-mini/global-mini-logo.png" width="330" height="72" alt="Mini Logo" /></a>
          </div>
        </div>
          <div className="container">
          <div id="navbar" className="navbar-collapse collapse">
            <ul className="nav navbar-nav">
              ...
              <li><a href="get-started.html">Kom i gang</a></li>
            </ul>
          </div>
        </div>
      </nav>
      ...
      <div className="container-fluid">
        <div className="mobile-logo center-block"><a href="/images/Blanchard-Norway-Logo-Black.png"><Image src="/images/Blanchard-Norway-Logo-Black.png"  width="330" height="167" alt="Secondary logo" /></a></div>
      </div>
    </>
  );
};
