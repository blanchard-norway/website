        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-4 center-block">
              <div className="aus-photo">
                <div className="content-show">
                  <Image
                    src="/images/global-partners-norway-v2/geir.jpg"
                    width={1383}
                    height={1608}
                    alt="Geir"
            ...
            <div className="col-lg-4 center-block">
              <div className="aus-photo">
                <div className="content-show">
                  <Image
                    src="/images/global-partners-norway-v2/team-photo-2.jpg"
                    width={1383}
                    height={1608}
                    alt="Team photo 2"
                    className="img-responsive"
            ...
            <div className="col-lg-4 center-block">
              <div className="aus-photo">
                <div className="content-show">
                  <Image
                    src="/images/global-partners-norway-v2/team-photo-3.jpg"
                    width={1383}
                    height={1608}
                    alt="Team photo 3"
                    className="img-responsive"
          ...
          <div className="col-lg-4 center-block">
            <div className="aus-photo">
              <div className="content-show">
                <Image
                  src="/images/global-partners-norway-v2/team-photo-4.jpg"
                  width={1383}
                  height={1608}
                  alt="Team photo 4"
                  className="img-responsive"
