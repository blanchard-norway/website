                ...
                <div className="box seventyfive-percent">
                  <div className="row row-eq-height">
                    <div className="col-sm-4 handshake-left vcenter hidden-xs">
                      <Image
                        src="/images/ls-legendary-service-customer-service-training program.png"
                  ...
                  <div className="row row-eq-height">
                    ...
                    <div className="col-sm-3 chain-right hidden-xs">
                      <Image
                        width={65}
                        height={72}
                        src="/images/ls-critical-customer-care-skills.png"
        ...
        <div className="container mobile-full">
          ...
          <div className="row icons" id="animateIcons">
            ...
            >
              <div className="icon">
                <Image
                  src="/images/ls-customer-service-skills-customer-loyalty.png"
            ...
            >
              <div className="icon">
                <Image
                  src="/images/ls-improved-customer-care-skills.png"
            ...
            >
              <div className="icon">
                <Image
                  src="/images/ls-excellent-customer-service-fans.png"
            ...
            >
              <div className="icon">
                <Image
                  src="/images/ls-excellent-customer-service-feedback.png"
            ...
            <div className="col-md-6 right">
              <div className="trust-graphic pull-right icare">
                <Image
                  width={522}
                  height={600}
                  src="/images/ls-i-care-customer-service-training-programs.png"
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <Image
                width={521}
                height={299}
                src="/images/legendary-service.jpg"
                className="img-responsive"
