          ...
          <div className="row row-eq-height productsboxes">
            <div className="col-lg-3 col-md-12 col-sm-12 col-xs-12 box">
              <div className="content-show">
                <Image
                  src="/images/products-home/p-sl2-development-training.jpg"
                  width={256}
                  height={172}
            ...
            <div className="col-lg-3 col-md-12 col-sm-12 col-xs-12 box">
              <div className="content-show">
                <Image
                  src="/images/products-home/p-self-leadership-training-programs.jpg"
                  width={256}
                  height={172}
            ...
            <div className="col-lg-3 col-md-12 col-sm-12 col-xs-12 box">
              <div className="content-show">
                <Image
                  src="/images/products-home/p-first-time-manager-leadership-development-training.jpg"
                  width={256}
                  height={172}
            ...
            <div className="col-lg-3 col-md-12 col-sm-12 col-xs-12 box">
              <div className="content-show">
                <Image
                  src="/images/products-home/p-tl-team-development-training.jpg"
                  width={256}
                  height={172}
            ...
            <div className="col-sm-10 col-sm-offset-1-and-half">
              <div className="row row-eq-height productsboxes center-block">
                <div className="col-lg-4 col-md-12 col-sm-12 col-xs-12 box">
                  <div className="content-show">
                    <Image
                      src="/images/products-home/p-building-trust-leadership-training.jpg"
                ...
                <div className="col-lg-4 col-md-12 col-sm-12 col-xs-12 box">
                  <div className="content-show">
                    <Image
                      src="/images/products-home/p-coaching-essentials-leadership-development-training.jpg"
                ...
                <div className="col-lg-4 col-md-12 col-sm-12 col-xs-12 box">
                  <div className="content-show">
                    <Image
                      src="/images/products-home/p-optimal-motivation-leadership-consulting-services.jpg"
            ...
            <div className="col-sm-6 col-sm-offset-3">
              <div className="row row-eq-height productsboxes second-row">
                <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 box">
                  <div className="content-show">
                    <Image
                      src="/images/products-home/p-legendary-service-leadership-consulting-services.jpg"
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 box">
                  <div className="content-show">
                    <Image
                      src="/images/products-home/p-organizational-change-leadership-training-programs.jpg"
