                  ...
                  <div className="row row-eq-height">
                    ...
                    <div className="col-sm-3 col-lg-2 thumbs-down-right hidden-xs">
                      <Image
                        width={81}
                        height={76}
                        src="/images/om-motivating-employee-creativity-engagement-in-the-workplace.png"
            ...
            >
              <div className="icon">
                <Image
                  width={124}
                  height={124}
                  src="/images/om-motivational-training-for-employees-increases-engagement.png"
            ...
            >
              <div className="icon">
                <Image
                  width={124}
                  height={124}
                  src="/images/om-optimal-motivation-in-organizations.png"
            ...
            >
              <div className="icon">
                <Image
                  width={124}
                  height={124}
                  src="/images/om-motivational-training-for-employees-improves-productivity.png"
            ...
            <div className="col-md-6 right">
              <div className="trust-graphic pull-right threeskills">
                <Image
                  width={2126}
                  height={2454}
                  src="/images/products-optimalmotivation-3skills.png"
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <Image
                width={521}
                height={299}
                src="/images/global_product_download_images/global_download_images-3.jpg"
                className="img-responsive"
