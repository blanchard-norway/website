                    ...
                    <div className="box">
                      <div className="row row-eq-height">
                        ...
                        <div className="col-sm-3 chain-right hidden-xs">
                          <Image
                            src="/images/icon-products-chain.png"
                            width={98}
                            height={108}
                            alt="Products Chain"
                          />
                    ...
                    <div className="box">
                      <div className="row row-eq-height">
                        <div className="col-sm-3 handshake-left vcenter hidden-xs">
                          <Image
                            src="/images/icon-products-handshake.png"
                            width={96}
                            height={66}
                            alt="Handshake"
                          />
        ...
        <div className="container mobile-full">
          ...
          <div className="row icons" id="animateIcons">
            ...
            >
              <div className="icon">
                <Image
                  src="/images/icon-products-chart.png"
                  width={124}
                  height={124}
                  alt="Products Chart"
                />
            ...
            >
              <div className="icon">
                <Image
                  src="/images/icon-products-brain.png"
                  width={124}
                  height={124}
                  alt="Products Brain"
                />
            ...
            >
              <div className="icon">
                <Image
                  src="/images/icon-products-men-ties.png"
                  width={124}
                  height={124}
      ...
      <section className="howto">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 right">
              <div className="trust-graphic pull-right">
                <Image
                  src="/images/products-trust-chain.png"
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <Image
                src="/images/global_product_download_images/global_download_images-7.jpg"
                className="img-responsive"
                width={521}
                height={299}
