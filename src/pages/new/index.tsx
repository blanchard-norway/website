            ...
            <Slider className="product-client-slides" {...settings}>
              ...
              <div className="client3">
                <div className="row">
                  <div className="col-lg-3 visible-lg">
                    <Image
                      src="/images/logo-fosterfarmschicken.png"
                      width={192}
                      height={172}
