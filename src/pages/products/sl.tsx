                ...
                <div id="box1">
                  <div className="content-show">
                    <FutureImage
                      ...
                      src="/img/sl2-sl2-training-research.png"
                      width={64}
                      height={65}
              ...
              <div className="col-md-3 col-sm-6 box">
                <div id="box2">
                  <div className="content-show">
                    <FutureImage
                      className="img-responsive"
                      src="/img/sl2-sl2-model-increased-productivity.png"
                      width={46}
                      height={54}
              ...
              <div className="col-md-3 col-sm-6 box">
                <div id="box3">
                  <div className="content-show">
                    <FutureImage
                      className="img-responsive"
                      src="/img/sl2-international-sl2-training.png"
                      width={63}
                      height={64}
              ...
              <div className="col-md-3 col-sm-6 box">
                <div id="box4">
                  <div className="content-show">
                    <FutureImage
                      className="img-responsive"
                      src="/img/sl2-sl2-theory-brain-science.png"
                      width={56}
                      height={60}
              ...
              <div className="row stats row-eq-height arrow-boxes">
                ...
                <div className="col-lg-3 col-md-2 col-sm-3 arrow center-block hidden-xs">
                  <div className="spacer">
                    <FutureImage
                      className="img-responsive"
                      src="/img/sl2-different-sl2-styles.png"
                      width={169}
                      height={91}
                ...
                <div className="col-lg-12" id="animateIcons">
                  ...
                  >
                    <div className="col-xs-3 center-block sl-icon">
                      <FutureImage
                        src="/img/sl2-sl2-style-accelerates-development.png"
                  ...
                  >
                    <div className="col-xs-3 center-block sl-icon">
                      <FutureImage
                        src="/img/sl2-sl2-model-common-language.png"
                  ...
                  >
                    <div className="col-xs-3 center-block sl-icon">
                      <FutureImage
                        src="/img/sl2-sl2-style-raises-morale.png"
                  ...
                  <div className="row icon" id="brain" ref={brain}>
                    <div className="col-xs-3 center-block sl-icon">
                      <FutureImage
                        src="/img/sl2-sl2-theory-problem-solving.png"
      ...
      <section className="howto optimal white">
        ...
        <div className="col-md-6 right">
          <div className="trust-graphic pull-right">
            <FutureImage
              src="/img/sl2-sl2-model-diagram.png"
      ...
      <section className="sl2experience">
        <div className="container">
                ...
                <div className="col-md-6">
                  <div className="row checkbox-chart">
                    <div className="col-sm-1 col-xs-1">
                      <FutureImage
                        src="/img/sl2-sl2-training-features.png"
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <FutureImage
                src="/img/global-mini/global-mini-learn-more.jpg"
                className="img-responsive"
