                ...
                <div className="row row-eq-height">
                  ...
                  <div className="col-sm-3 clock-right hidden-xs">
                    <Image
                      width={87}
                      height={87}
                      src="/img/st-team-meetings-team-leadership-model.png"
                ...
                <div className="row row-eq-height">
                  <div className="col-sm-3 handshake-left vcenter hidden-xs">
                    <Image
                      width={65}
                      height={69}
                      src="/img/st-team-leadership-training-for-organizations.png"
            ...
            <div className="container mobile-full">
              ...
              <div className="row icons" id="animateIcons">
                ...
                >
                  <div className="icon">
                    <Image
                      src="/img/st-high-performing-team-leadership-styles.png"
                ...
                >
                  <div className="icon">
                    <Image
                      src="/img/st-team-leadership-model-superior-results.png"
                ...
                >
                  <div className="icon">
                    <Image
                      src="/img/st-situational-team-leadership-skills%20teamwork.png"
                ...
                >
                  <div className="icon">
                    <Image
                      src="/img/st-high-performing-teams-team-leadership%20training.png"
            ...
            <div className="col-md-6 right">
              <div className="trust-graphic pull-right team-performance">
                <Image
                  width={484}
                  height={497}
                  src="/img/team-leadership-model.png"
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <Image
                width={521}
                height={299}
                src="/img/global_product_download_images/global_download_images-8.jpg"
                className="img-responsive"
                alt="Global Download"
              />
            </div>
