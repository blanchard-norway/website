                  ...
                  <div className="row row-eq-height">
                    ...
                    <div className="col-sm-2 step hidden-xs">
                      <Image
                        width={87}
                        height={87}
                        src="/img/sl-organizational-success-self-leadership-development.png"
        ...
        <div className="container mobile-full">
          ...
          <div className="row icons" id="animateIcons">
            ...
            >
              <div className="icon">
                <Image
                  src="/img/sl-self-leadership-skills-accelerator.png"
            ...
            >
              <div className="icon">
                <Image
                  src="/img/sl-self-leadership-skills-performance-improvements.png"
            ...
            >
              <div className="icon">
                <Image
                  src="/img/sl-self-development-accountability-programs.png"
            ...
            >
              <div className="icon">
                <Image
                  src="/img/sl-self-leadership-development-innovation.png"
          ...
          <div className="row row-eq-height side-by-side-graphics">
            <div className="col-md-6 left">
              <Image
                width={483}
                height={434}
                src="/img/sl-self-leadership-development-mindset-chart.png"
            ...
            <div className="col-md-6 right">
              <div className="trust-graphic pull-right">
                <Image
                  width={483}
                  height={432}
                  src="/img/sl-self-leadership-skills-diagram.png"
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <Image
                ...
                src="/img/global_product_download_images/global_download_images-11.jpg"
                className="img-responsive"
              />
            </div>
