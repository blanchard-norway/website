                ...
                <div className="box">
                  <div className="row row-eq-height">
                    ...
                    <div className="col-sm-3 col-lg-2 step hidden-xs">
                      <Image
                        src="/img/icon-products-step.png"
                        alt="Products Step"
                        width={88}
                        height={98}
                      />
              ...
              <div className="row">
                ...
                <div className="row icons" id="animateIcons">
                  ...
                  >
                    <div className="icon">
                      <Image
                        src="/img/icon-products-speed.png"
                        width={124}
                        height={124}
                        alt="Speed"
                      />
                  ...
                  >
                    <div className="icon">
                      <Image
                        src="/img/icon-products-gear.png"
                        width={124}
                        height={124}
                        alt="Gear"
                      />
                  ...
                  >
                    <div className="icon">
                      <Image
                        src="/img/icon-products-3-people.png"
                        width={124}
                        height={124}
                        alt="People"
                      />
      ...
      <section className="howto">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6 right">
              <div className="trust-graphic pull-right">
                <Image
                  src="/img/products-coaching-process.png"
                  alt="Process"
                  width={7535}
                  height={9561}
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <Image
                src="/img/global_product_download_images/global_download_images-5.jpg"
                alt="Global Download"
                width={521}
                height={299}
                className="img-responsive"
