                  ...
                  <div className="row row-eq-height">
                    <div className="col-sm-3 arrow-right hidden-xs">
                      <Image
                        ...
                        src="/img/icon-products-down-arrow.png"
                      />
                    </div>
                  ...
                  <div className="row row-eq-height">
                    ...
                    <div className="col-sm-2 question-right hidden-xs">
                      <Image
                        ...
                        src="/img/icon-products-question.png"
                      />
                    </div>
                  </div>
                </div>
            ...
            >
              <div className="icon">
                <Image
                  ...
                  src="/img/icon-products-walking-up.png"
                />
              </div>
            ...
            >
              <div className="icon">
                <Image
                  ...
                  height={124}
                  alt="Products 3 Ties"
                  src="/img/icon-products-3-ties.png"
                />
              </div>
          ...
          <div className="row row-eq-height side-by-side-graphics">
            <div className="col-md-6 left">
              <Image
                ...
                src="/img/products-managers-4-core-conversations.png"
            ...
            <div className="col-md-6 right">
              <div className="trust-graphic pull-right">
                <Image
                  ...
                  src="/img/products-managers-4-essential-skills.png"
                  className="img-responsive"
                />
              </div>
            </div>
          ...
          <div className="row margin-30">
            <div className="col-md-6 left">
              <Image
                ...
                src="/img/global_product_download_images/global_download_images-10.jpg"
                className="img-responsive"
              />
            </div>
