        ...
        <div className="container">
          ...
          <div className="row margin-14">
            <div className="col-md-4 ken-photo">
              <Image
                src="/img/about-us-team-ken/ak-ken-blanchard-chief-spiritual-officer.jpg"
                ...
                <span className="social-icon">
                  ...
                  >
                    <Image
                      ...
                      width={31}
                      height={31}
                      src="/img/about-us-team-ken/icon-twitter.png"
                    />
                  </a>
                </span>
                <span className="social-icon">
                  ...
                  >
                    <Image
                      ...
                      width={31}
                      height={31}
                      src="/img/about-us-team-ken/icon-linkedin.png"
                    />
                  </a>
                </span>
              </div>
              ...
              >
                <Image
                  src="/img/about-us-team-ken/ak-ken-blanchard-bio-download.png"
            ...
            <div className="row awards">
              <div className="col-md-2 col-sm-offset-1 text-center award">
                <Image
                  width={124}
                  height={81}
                  src="/img/about-us-team-ken/ak-inc-leadership-training-award.png"
              ...
              <div className="col-md-2 text-center award">
                <Image
                  width={129}
                  height={81}
                  src="/img/about-us-team-ken/ak-nsa-manager-training-award.png"
              ...
              <div className="col-md-2 text-center award">
                <Image
                  width={160}
                  height={81}
                  src="/img/about-us-team-ken/ak-tm-leadership-training-award.png"
              ...
              <div className="col-md-2 text-center award">
                <Image
                  width={90}
                  height={81}
                  src="/img/about-us-team-ken/ak-toastmaster-manager-training-award.png"
              ...
              <div className="col-md-2 text-center award">
                <Image
                  width={110}
                  height={81}
                  src="/img/about-us-team-ken/ak-isa-leadership-training-award.png"
                  ...
                  <div className="watch-now">
                    <a href="https://youtu.be/nBdJRuirKbM" data-lity>
                      <Image
                        ...
                        width={140}
                        height={34}
                        src="/img/about-us-team-ken/btn-watch-now.png"
                      />
                    </a>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/New-One-Minute-Manager-cover-sm.png"
                ...
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/ak-customer-service-excellence-book.jpg"
                ...
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/TrustWorks-Book-sm.jpg"
                    style={{ maxWidth: '95px' }}
                ...
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/Gung-Ho-book2-sm.jpg"
                ...
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/self-leadership-and-the-one-minute-manager-revised-edition-sm.jpg"
                ...
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/whale-done-2-sm.jpg"
                ...
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/ak-leading-at-a-higher-level-book.jpg"
                ...
                <div className="col-sm-3 text-center">
                  <Image
                    width={95}
                    height={142}
                    src="/img/ken/One-Minute-Manager-Builds-High-Performing-Teams-sm.jpg"
